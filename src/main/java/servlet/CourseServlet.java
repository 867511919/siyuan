...
//        cd.saveCourse(cs);
//
////        int bMovid=cd.QueryByMovId(Movid);  断点与数字id绑定
//        String bMovid=Movid;
...
//        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(request.getParameter("updateid")!=null){
            String movId=request.getParameter("updateid");
            course cs=null;
            ArrayList<BreakPoint> list=new ArrayList<BreakPoint>();
            try {
                String movStr=ab.GetMovinfo(movId);
                cs=apiUtil.getJson(movStr);
            ...
            request.setAttribute("bplist",list);
            request.setAttribute("course",cs);
            request.getRequestDispatcher("../fixCourse.jsp").forward(request,response);
        }
    }
}
